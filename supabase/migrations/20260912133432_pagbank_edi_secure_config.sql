...
-- A configuração é operada exclusivamente pelas Edge Functions com service_role.
-- Nenhuma policy para anon/authenticated: o token permanece inacessível pelo Data API.
...
-- Credenciais da API Order/Pix são independentes das credenciais EDI.
