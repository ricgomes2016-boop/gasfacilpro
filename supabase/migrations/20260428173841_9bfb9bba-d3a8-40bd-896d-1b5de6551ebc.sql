...
REVOKE EXECUTE ON FUNCTION public.gerar_codigo_indicacao_cliente(uuid, text) FROM anon;
REVOKE EXECUTE ON FUNCTION public.fn_cliente_indicacao_before_save() FROM anon;
REVOKE EXECUTE ON FUNCTION public.fn_criar_registro_indicacao_cliente() FROM anon;
REVOKE EXECUTE ON FUNCTION public.fn_converter_indicacao_primeiro_pedido() FROM anon;