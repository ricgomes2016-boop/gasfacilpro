  ...
  try {
    ...
    if (!clienteId && (orderData.nome || senderName)) {
      ...
      if (!clienteError && novoCliente) {
        ...
        console.log("Auto-registered new client:", nomeCliente, normalized);

        // Link to unidade via cliente_unidades
        if (unidadeId) {
    ...
    console.log("Order created:", pedido.id, "unidade:", unidadeId, "produto:", produto.nome, "cliente:", clienteId);
  } catch (e) {
