...
export const DASHBOARD_PASTEL_PRIMARY = "221 83% 53%";

export const COLOR_OPTIONS = [
  { hsl: DASHBOARD_PASTEL_PRIMARY, label: "Azul ERP", hex: "#2563EB" },
...
export const THEME_PRESETS = [
  ...
  },
  {
    ...
    description: "Tema fixo do sistema: ERP claro, azul operacional, laranja discreto e campos objetivos",
    cor: DASHBOARD_PASTEL_PRIMARY,
    hex: "#2563EB",
    dark: false,
    gradient: "linear-gradient(135deg, #2563EB 0%, #1E40AF 52%, #F97316 100%)",
...
export const PRESET_THEME_OVERRIDES: Record<string, Record<string, string>> = {
  "prestige-emerald": {
    ...
    "--muted": "163 14% 95%",
    "--muted-foreground": "163 12% 38%",
    "--accent": "43 55% 54%",
    "--accent-foreground": "162 40% 12%",
    "--border": "163 12% 90%",
    "--input": "163 12% 90%",
    "--ring": "163 80% 26%",
    "--radius": "0.75rem",
    "--sidebar-background": "162 85% 17%",
    "--sidebar-gradient-from": "163 80% 26%",
    "--sidebar-gradient-to": "162 85% 15%",
    "--sidebar-foreground": "163 20% 94%",
    "--sidebar-primary": "43 55% 54%",
    "--sidebar-primary-foreground": "162 40% 12%",
    "--sidebar-accent": "163 80% 26%",
    "--sidebar-accent-foreground": "0 0% 100%",
    "--sidebar-border": "162 45% 24%",
    ...
    "--chart-5": "38 45% 62%",
    "--chart-6": "150 30% 58%",
    "--kpi-accent": "163 80% 26%",
    "--gradient-primary": "linear-gradient(135deg, hsl(163 80% 26%) 0%, hsl(162 85% 15%) 100%)",
    "--shadow-glow": "0 0 28px hsl(163 80% 26% / 0.24)",
  },
  "premium-light": {
  ...
  "dashboard-pastel": {
    ...
    "--gradient-primary": "linear-gradient(135deg, hsl(221 83% 53%) 0%, hsl(221 83% 33%) 100%)",
