...
export function Sidebar() {
  ...
  const menuItemActive = "gradient-primary text-primary-foreground shadow-lg shadow-foreground/10 ring-1 ring-sidebar-border/25";
  ...
  const subMenuItemActive = "gradient-primary text-primary-foreground shadow-sm ring-1 ring-sidebar-border/25";
