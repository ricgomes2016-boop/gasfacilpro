  ...
  return (
    <Card className="border-border/40">
      <CardContent className="p-4 space-y-3">
        ...
        {linhas.length === 0 ? (
          <p className="text-xs text-muted-foreground py-6 text-center">Sem compras de cheio no período</p>
        ) : (
            ...
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y divide-border/40">
                ...
                <tr className="bg-muted/40 font-bold">
                  <td className="px-3 py-2 text-foreground" colSpan={2}>Total Geral (Cheio)</td>
